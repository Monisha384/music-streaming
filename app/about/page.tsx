    ...
    <main className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-5xl">
          <p className="text-sm font-bold uppercase tracking-[0.25em] text-emerald-300">About MusicVerse</p>
          ...
          <p className="mt-6 max-w-3xl text-xl leading-9 text-zinc-200">
            MusicVerse helps listeners explore songs, artists and playlists across two languages. It highlights Tamil composers like Yuvan, Anirudh, A. R. Rahman and Ilayaraja while keeping English pop, rock and acoustic hits easy to find.
          </p>
